    ...
    <div className="h-screen w-screen bg-white flex flex-col relative overflow-hidden font-sans select-none">
      ...
      <main className="flex-grow flex flex-col items-center justify-evenly p-4 pb-0 relative z-10 w-full max-w-5xl mx-auto">
        ...
        <div className="text-center w-full mt-4">
           ...
           {/* text-[15vw] ensures it fits width on mobile, md:text-9xl caps it on desktop */}
        ...
        <div className="flex flex-col items-center justify-center w-full gap-4">
           ...
           <div className="relative group cursor-pointer mx-auto" onClick={() => triggerAuthModal()}>
              ...
              {/* Responsive Size: w-[45vw] on mobile, capped at 280px on desktop */}
        ...
        <div className="grid grid-cols-2 gap-4 w-full max-w-sm">
            <button 
              ...
              className="py-4 bg-slate-50 hover:bg-slate-100 rounded-2xl border-2 border-slate-100 transition-all flex flex-col items-center justify-center gap-1 group active:scale-95"
            >
              <Keyboard size={20} className="text-slate-400 group-hover:text-black" />
              <span className="text-[10px] md:text-xs font-black uppercase tracking-widest text-slate-500 group-hover:text-black">Gate Pass</span>
            </button>
            ...
            <button 
              ...
              className="py-4 bg-slate-50 hover:bg-slate-100 rounded-2xl border-2 border-slate-100 transition-all flex flex-col items-center justify-center gap-1 group active:scale-95"
            >
              <UserPlus size={20} className="text-slate-400 group-hover:text-black" />
              <span className="text-[10px] md:text-xs font-black uppercase tracking-widest text-slate-500 group-hover:text-black">Visitor</span>
            </button>
        </div>
      </main>
         ...
         <div className="max-w-4xl mx-auto flex flex-col gap-3">
            ...
            <div className="flex justify-between items-center px-2">
               ...
               <button 
                  ...
                  className="flex items-center gap-1.5 text-[9px] font-black uppercase text-slate-900 hover:text-emerald-600 transition-colors px-2 py-1 rounded-lg hover:bg-white"
               >
