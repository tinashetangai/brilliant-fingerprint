...
import { Search, Trash2, Edit3, X, QrCode, ShieldAlert, ChevronRight, Phone, MapPin, Heart, Clock, Users, UserMinus, UserCheck, Briefcase, Hash } from 'lucide-react';
        ...
        {showAddForm && (
          <div className="p-6 md:p-8 bg-slate-50 rounded-[2.5rem] border border-slate-200 animate-in slide-in-from-top-4 shadow-sm">
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
               ...
               <div className="md:col-span-2 lg:col-span-3"><button onClick={handleSubmit} className="w-full py-4 bg-black text-white rounded-2xl font-black uppercase text-xs shadow-lg active:scale-95 transition-all tracking-widest">Register User</button></div>
             </div>
          </div>
        )}
