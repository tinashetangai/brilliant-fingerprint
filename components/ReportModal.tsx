...
import { X, Printer, Calendar, ShieldCheck, FileCheck, Users, Zap, Briefcase } from 'lucide-react';
      ...
      <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-[1200px] h-[94vh] flex flex-col animate-in zoom-in duration-300 overflow-hidden border border-white/20">
        ...
        <div className="px-8 py-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
          ...
          <div className="flex items-center gap-2">
            <button onClick={handlePrint} className="px-6 py-3 bg-black text-white rounded-xl transition-all flex items-center gap-2 font-black uppercase text-[10px] shadow-lg hover:scale-105 active:scale-95 tracking-widest">
